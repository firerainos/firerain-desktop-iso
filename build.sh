...
make_syslinux() {
    ...
    for _cfg in ${script_path}/syslinux/*.cfg; do
        sed "s|%FIRERAINISO_LABEL%|${iso_label}|g;
...
make_efi() {
    ...
    sed "s|%FIRERAINISO_LABEL%|${iso_label}|g;
        ...
        ${script_path}/efiboot/loader/entries/firerainiso-x86_64-usb.conf > ${work_dir}/iso/loader/entries/firerainiso-x86_64.conf
...
make_efiboot() {
    ...
    mkfs.fat -n FIRERAINISO_EFI ${work_dir}/iso/EFI/archiso/efiboot.img
    ...
    sed "s|%FIRERAINISO_LABEL%|${iso_label}|g;
         s|%INSTALL_DIR%|${install_dir}|g" \
        ${script_path}/efiboot/loader/entries/firerainiso-x86_64-cd.conf > ${work_dir}/efiboot/loader/entries/firerainiso-x86_64.conf
